...
/**
 * @license Copyright 2012 Marco Braak
 *
  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._loadFolderOnDemand = function(node, skip_slide, on_finished) {
      var $li, data_url, folder_element, loaderHandler,
        _this = this;
      node.load_on_demand = false;
      data_url = this._getDataUrl(node);
      loaderHandler = _this.options.onNodeRequired;
      folder_element = new FolderElement(node, this);
      if (loaderHandler && folder_element) {
        $li = folder_element.getLi();
        $li.addClass('jqtree-loading');
        return this._loadDataFromServer(node, function(data) {
    ...
    JqTreeWidget.prototype._initData = function() {
      ...
      if (this.options.data) {
        ...
        if (_this.options.onNodeRequired) {
          return this._loadDataFromServer(null, function(data) {
    ...
    JqTreeWidget.prototype._loadDataFromServer = function(node, on_success) {
      var _this = this;
      if(_this.options.onNodeRequired) {
          _this.options.onNodeRequired(node, on_success);
          return;
      }
      /*
      return $.ajax({
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createLi = function(node) {
        ...
        $checkbox.change(function() {
            ...
            if (_this.options.onNodeCheck) {
                _this.options.onNodeCheck(node, $li, (checked == "checked"));
            }
        });
